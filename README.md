...
- Loading unzipped data
- Reading the activity, subject and features train and test data separately
- Merging train and test data for activity, subject and features using rbind
- Merging all columns of the abovementioned in one full data set using cbind
